...
\node (n2) at (0,1) {публично/непублично};
...
\uncover<3->{
\node[align=center] (n31) at (0.5,2) {нарушать/не нарушать\\ телесные границы};
\node (n32) at (1.5,2) {нос/не нос};
\draw (n3) -- (n31);
\draw (n3) -- (n32);
}
\uncover<4->{
\node[align=center] (n11) at (-0.5,2) {доминирование/\\унижение};
\node[align=center] (n12) at (-1.5,2) {разрешение/\\запрещение};
\draw (n1) -- (n11);
\draw (n1) -- (n12);
}
\end{tikzpicture}
