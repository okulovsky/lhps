...
\begin{bframe}
\begin{Reason}
\from{Все хакеры разбираются в компьютерах}
\from{Все программисты разбираются в компьютерах}
\conc{Все программисты -- хакеры}
\end{Reason}
\end{bframe}
...
\uncover<+->{Рассуждение \textcolor{accent}{\bf обоснованно}, если все его посылки истинны}
