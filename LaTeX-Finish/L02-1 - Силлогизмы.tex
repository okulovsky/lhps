...
\from[2]{<<Желаемый образ будущего тебя>> ел рыбий жир}
...
\begin{bframe}
\begin{Reason}
\from{Все анархисты-террористы против правительства}
\from{Все оппозиционеры против правительства}
\conc{Все оппозиционеры -- анархисты-терроритсы}
\end{Reason}
\end{bframe}
