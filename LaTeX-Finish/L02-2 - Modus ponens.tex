...
\uncover<4->{
\draw[color=chartlightaccent, ultra thick] (n.north west) -- (n.south east);
\draw[color=chartlightaccent, ultra thick] (n.north east) -- (n.south west);
...
\uncover<5->{Если в первой комнате принцессе, то утверждение I истинно. Тогда во второй комнате тигр. Тогда утверждение II истинно. Противоречий нет.}
